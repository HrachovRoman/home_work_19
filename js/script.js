...
console.log('необходимо сложить', newArr.length, 'элементов');
...
// let sum = arr.flat().reduce((a, b) => a + b, 0); // и вот такой метод еще можно, тоже работает.
console.log(sum);
